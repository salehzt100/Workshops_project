            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        var vehicle = data[i];
                        var vehicleContainer = $('<div class="vehicleContainer grid-cols-1 scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 m-4 p-3 border border-white"></div>');

                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-white text-xl leading-relaxed font-weight-bold flex sm:justify-between">' +'<span> name :</span> '+vehicle.vehicle_name + '</div>');
                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed flex sm:justify-between">' +'<span> type :</span> '+ vehicle.vehicle_type + '</div>');
                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed flex sm:justify-between">' +'<span> full price :</span> '+vehicle.full_vehicles_price + '</div>');
                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed flex sm:justify-between">' +'<span> paid so far :</span> '+vehicle.total_amount_paid_so_far + '</div>');
                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed flex sm:justify-between gap-4">' +'<span> remaining amount :</span> '+ vehicle.remaining_amount + '</div>');
                        vehicleContainer.append('<div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed flex sm:justify-between">' +'<span> status :</span> '+ vehicle.status + '</div>');

                        $('#vehicles').append(vehicleContainer);
                    }
                },
...
<div
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <a href="https://laracasts.com"
                   class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div>
                        ...
                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"><strong>
        ...
        <div id="vehicles" class=" flex flex-betwen gap-4" >
        </div>
    </div>
</div>
